...
- App (dist): `/var/www/partidodelasoledad/app/dist`
...
```bash
sudo mkdir -p /var/www/partidodelasoledad/{img,www,logs}
sudo chown ubuntu:ubuntu /var/www/partidodelasoledad/{img,www,logs}
...
git clone git@github.com:partidodelasoledad/app.git /var/www/partidodelasoledad/app
sudo chown -R ubuntu:ubuntu /var/www/partidodelasoledad/{api,app}
```
...
```bash
npm run build
rsync -avz --delete dist/ usuario@IP_DEL_VPS:/var/www/partidodelasoledad/app/dist/
```
